...
#define CONFIG_EXAMPLES_DIR "BigTreeTech SKR 1.4 Turbo"
...
#define STRING_CONFIG_H_AUTHOR "Mark Gagnon (A10M SKR1.4 Turbo)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "A10M SKR1.4 Turbo - 1.0"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // #define DEFAULT_Kd 135.84

  // Creality Ender-5
  // #define DEFAULT_Kp 21.89
  // #define DEFAULT_Ki 1.82
  // #define DEFAULT_Kd 65.67
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // // SKR1.4 Turbo
  // #define DEFAULT_bedKp 85.42
  // #define DEFAULT_bedKi 16.04
  // #define DEFAULT_bedKd 303.21

  //120V 250W silicone heater into 4mm borosilicate (MendelMax 1.5+)
  //from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
  // #define DEFAULT_bedKp 227.94
  // #define DEFAULT_bedKi 45.54
  // #define DEFAULT_bedKd 760.57
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 81.2, 81.73, 410.36, 138.8 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -39, 1, 0 }
...
#define MANUAL_X_HOME_POS -11.5
#define MANUAL_Y_HOME_POS -3.5
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { {  0, 10, (Z_MIN_POS + 5) } }
  #define NOZZLE_CLEAN_END_POINT   { { 8, 50, (Z_MIN_POS + 5) } }

  // Circular pattern radius
  #define NOZZLE_CLEAN_CIRCLE_RADIUS 4
